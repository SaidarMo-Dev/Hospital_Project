...
namespace Hospital_DataAccessLayer
{
    ...
    public class clsPrescriptionsDataAccess
    {
        ...
        public static bool GetPrescriptionsInfoByID(int PrescriptionID, ref int MedicalRecordID, ref string MedicalName, ref string Dosage, ref string Frequency, ref DateTime StartDate, ref DateTime NedDate, ref string SpecialInstructions, ref int CreatedByUserID)
        {
            bool IsFound = false;
        ...
        public static int AddNewPrescriptions(int MedicalRecordID, string MedicalName, string Dosage, string Frequency, DateTime StartDate, DateTime NedDate, string SpecialInstructions, int CreatedByUserID)
        {
            int InsertedID = -1;
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.connectionString))
                {
                    ...
                    string query = @"INSERT INTO Prescriptions(MedicalRecordID, MedicalName, Dosage, Frequency, StartDate, NedDate, SpecialInstructions, CreatedByUserID)
                                   
                                       VALUES (@MedicalRecordID, @MedicalName, @Dosage, @Frequency, @StartDate, @NedDate, @SpecialInstructions, @CreatedByUserID) 
        ...
        public static bool UpdatePrescriptions(int PrescriptionID, int MedicalRecordID, string MedicalName, string Dosage, string Frequency, DateTime StartDate, DateTime NedDate, string SpecialInstructions, int CreatedByUserID)
        {
            int RowsAffected = -1;
        ...
        public static DataTable GetPaientPrescriptions(int patientID)
        {
            DataTable dtList = new DataTable();
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.connectionString))
                {
                    ...
                    string query = @" Select MedicalName, Dosage, Frequency From Prescriptions
