...
namespace Hospital_Presentation.Users
{
    public partial class frmAddUpdateUser : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                if (_mode == enMode.Update || !clsUser.IsPersonHasUser(ctrlPersonInfoCardWithFilter1.SelectedPersonInfo.PersonID))
                {
				...
				{
					MessageBox.Show("This person Already has user Choose Another person",
